...
def main() -> None:
    ...
    queue_builder_path = ROOT / "scripts" / "step16_build_v8_context_review_queues.py"
    if summary.get("producer_sha256") != common.sha256(queue_builder_path):
        raise ValueError("Step16-v8 queue was generated by a different queue-builder revision")
