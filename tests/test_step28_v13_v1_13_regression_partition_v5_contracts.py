...
import step28_v13_v1_13_regression_partition_v5 as partition


class RegressionPartitionV5Contracts(unittest.TestCase):
    @classmethod
    ...
    def test_current_discovery_boundary_is_exact(self) -> None:
        ...
        self.assertEqual(len(historical), 37)
        self.assertEqual(len(active), boundary["active_scheduled_test_count"])

    def test_only_three_passed_predecessor_discovery_assertions_are_partitioned(self) -> None:
        ...
        self.assertEqual(evidence["v4_test_id"], self.contract["superseded_discovery_test_ids"][2])
