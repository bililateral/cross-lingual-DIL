...
- canonical Step12 outputs are isolated under `reports/step12_v6/method_audit_v4_inductive_20260712/`, require exactly 5000 bootstrap resamples and 5000 paired randomizations, and refuse to overwrite any existing target;
...
- run `bash scripts/run_step15_v6_linux_20260711.sh`, inspect Step12 v4 promotion, and run `bash scripts/run_step11_v6_after_promotion_20260711.sh` only if promotion is eligible.
