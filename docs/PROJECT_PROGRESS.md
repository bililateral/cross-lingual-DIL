...
仓库外 2,018 字节一次性回执／`a3c7a0dc750bd098d72e6d17db66a1dfbcabe2e226417260bb86845855677b9d` 经唯一无参数入口消费。构建完成训练／开发／审核甲／审核乙 500／500／2／2 个世界并正常退出。发布根含 77 个文件、1,464,158,039 字节，根清单规范自哈希为 `f10086faa5f68b08a4d25a6e49943fb18ede0858ca50bad711d7bbb2f4d94200f`。发布后全量重读 1.46 GB，逐文件大小、摘要、行数及清单自哈希均闭合；临时根和待用回执均不存在。
