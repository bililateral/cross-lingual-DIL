...
- The E5 LR/L2 positive-pair mixup 100pct seed-mean has the strongest current fixed-test point estimate, with AUC delta 0.035294 and AP delta 0.068422 versus raw E5; Step 12 paired bootstrap decides whether this can be treated as a robust improvement.
...
- Current manifest-only Step 11 cluster audit is dominated by non-controller evidence types: 111 template/topic clusters vs 0 anchored same-controller cores.
...
| --- | --- | --- | --- | --- | --- |
| step11_manifest_scope |  |  |  |  |  |
| step11_cluster_audit_decision | same_controller_high_confidence | 0 |  | explicit | 125 |
| step11_cluster_audit_decision | same_controller_core_with_possible_expansion | 0 |  | explicit | 125 |
| step11_cluster_audit_decision | partial_anchor | 6 |  | explicit | 125 |
| step11_cluster_audit_decision | template_clone_not_controller | 59 |  | explicit | 125 |
| step11_cluster_audit_decision | semantic_topic_not_controller | 52 |  | explicit | 125 |
| step11_cluster_audit_decision | uncertain | 8 |  | explicit | 125 |
